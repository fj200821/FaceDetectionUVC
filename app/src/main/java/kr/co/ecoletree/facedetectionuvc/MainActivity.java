package kr.co.ecoletree.facedetectionuvc;
...
public class MainActivity extends BaseActivity implements CameraDialog.CameraDialogParent {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mCameraButton = (ToggleButton)findViewById(R.id.camera_button); // 카메라 사용/해제 버튼
    ...
    private final Runnable mUpdateItemsOnUITask = new Runnable() {
        ...
        public void run() {
            ...
            final Bitmap bm = mUVCCameraView.getBitmap();
